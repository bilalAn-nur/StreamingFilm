...
const Sidebar = () => {
  return (
    <div>
      ...
      <div className="hidden md:flex flex-col bg-gray-900 text-white w-28 py-6 space-y-6 fixed h-screen items-center">
        ...
        <div className="space-y-12 mt-10">
          <svg
            ...
            viewBox="0 0 640 640"
            className="h-8 w-8 text-white hover:text-red-500 transition-all duration-300 hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(255,0,0,0.7)]"
            fill="currentColor"
          >
      ...
      <div className="flex md:hidden fixed bottom-0 left-0 w-full bg-gray-900 text-white py-2 justify-around z-50">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 640"
          className="h-8 w-8 text-white hover:text-red-500 transition-all duration-300 hover:scale-125 hover:drop-shadow-[0_0_10px_rgba(255,0,0,0.7)]"
